...
const I18N = {
  ...
  DICT: {
    en: {
      ...
      tab_characters: 'Heroes', tab_hats: 'Hats', tab_skins: 'Skins', skin_btn: 'SKIN', tab_powerups: 'Power-ups',
    ...
    nl: {
      ...
      tab_characters: 'Heroes', tab_hats: 'Hoeden', tab_skins: 'Skins', skin_btn: 'SKIN', tab_powerups: 'Power-ups',
...
I18N.CONTENT = {
  en: {
    ...
    chars: {
      ...
      zwabber: { name: 'Swabbie' }, kanonnier: { name: 'Gunner' }, uitkijk: { name: 'Lookout' },
    ...
    abilities: {
      ...
      anchorslam: { name: 'Anchor Slam', desc: 'Slams a giant anchor into the ground: 45 damage and huge knockback to everyone in a large circle.' },
      bananas: { name: 'Monkey Mayhem', desc: 'Throws 3 bananas that bounce around the arena: 15 damage on a hit. Step on a peel afterwards and you slip for 0.8s. You move faster for a moment.' },
    ...
    skinrarity: {
      common: { name: 'Common' }, rare: { name: 'Rare' }, legendary: { name: 'Legendary' },
    },
    skins: {
      ryan_azure: { name: 'Azure' }, ryan_crimson: { name: 'Crimson' }, ryan_gold: { name: 'Golden Ryan' },
      jenze_forest: { name: 'Forest Ranger' }, jenze_royal: { name: 'Royal' },
      tygo_sand: { name: 'Desert Son' }, tygo_shadow: { name: 'Shadow Hunter' },
      vince_ice: { name: 'Ice Vince' }, vince_ember: { name: 'Ember' },
      timo_lime: { name: 'Lime' }, timo_neon: { name: 'Neon' },
      just_smith: { name: 'Blacksmith' }, just_bronze: { name: 'Bronze' },
      ricky_arctic: { name: 'Arctic' }, ricky_venom: { name: 'Venom' },
      yarno_midnight: { name: 'Midnight' }, yarno_bloodmoon: { name: 'Blood Moon' },
      pirate_navy: { name: 'Navy' }, pirate_ghost: { name: 'Ghost Captain' },
      skeleton_gilded: { name: 'Gilded' }, skeleton_infernal: { name: 'Infernal' }, skeleton_frost: { name: 'Frost Knight' },
      ninja_crimson: { name: 'Crimson Ninja' }, ninja_gold: { name: 'Golden Ninja' },
      monnik_jade: { name: 'Jade' },
      guardian_obsidian: { name: 'Obsidian' },
      kong_albino: { name: 'Albino King' },
      koba_ashen: { name: 'Ashen' },
      bonzo_snow: { name: 'Snow Ape' },
    },
    hats: {
...
I18N._maps = [
  ...
  { key: 'skins', ref: function () { return typeof SKINS !== 'undefined' ? SKINS : null; }, fields: ['name'] },
  { key: 'skinrarity', ref: function () { return typeof SKIN_RARITY !== 'undefined' ? SKIN_RARITY : null; }, fields: ['name'] },
...
I18N.UI_EN = {
  ...
  'Skins zijn puur uiterlijk — ze veranderen niets aan je stats.': 'Skins are purely cosmetic — they change nothing about your stats.',
  'Standaard': 'Default',
  'VERBINDING VERBROKEN': 'CONNECTION LOST',
  'Verbinding hapert — opnieuw verbinden…': 'Connection issue — reconnecting…',
  'De verbinding met je tegenstander viel weg. Deze match telt niet mee — je rank en munten blijven ongewijzigd.': "You lost connection to your opponent. This match doesn't count — your rank and coins are unchanged.",
  'Je hebt nog geen skins voor deze held. Koop ze in de shop bij Skins.': "You don't have any skins for this hero yet. Buy them in the shop under Skins.",
  'Koop eerst een held — daarna kun je hier skins voor hem kopen.': 'Buy a hero first — then you can buy skins for them here.',
  ...
  'Kansen bekijken': 'View odds',
  'Kansen': 'Odds',
  'Elke crate geeft': 'Each crate gives',
  'power-ups — kans per power-up:': 'power-ups — chance per power-up:',
