...
const I18N = {
  ...
  DICT: {
    en: {
      ...
      tab_characters: 'Heroes', tab_hats: 'Hats', tab_skins: 'Skins', tab_powerups: 'Power-ups',
    ...
    nl: {
      ...
      tab_characters: 'Heroes', tab_hats: 'Hoeden', tab_skins: 'Skins', tab_powerups: 'Power-ups',
...
I18N.CONTENT = {
  en: {
    ...
    skins: {
      ...
      skeleton_gilded: { name: 'Gilded' }, skeleton_infernal: { name: 'Infernal' },
